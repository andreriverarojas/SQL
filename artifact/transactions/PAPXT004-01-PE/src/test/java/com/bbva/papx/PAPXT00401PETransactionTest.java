...
/**
 * Test for transaction PAPXT00401PETransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PAPXT00401PETest.xml" })
public class PAPXT00401PETransactionTest {

	@Autowired
	private PAPXT00401PETransaction transaction;
